...
(function() {
  var activateIframe, appendToCache, cacheSize_forward, defaultURL, inCache, main, mainelement, makeHash, makeIframe, prependToCache, removeFromCache, scroll, scrollAmount, sendMessageToIframe, setLinks, update, updateFromHash,
  ...
  window.onmessage = function(event) {
    ...
    if (data.interactive) {
      return getIframe(data.page).attr('interactive', true);
    }
  };
